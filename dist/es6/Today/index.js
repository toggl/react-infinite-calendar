...
var Today = function (_Component) {
	...
	function Today() {
		...
		return _ret = (_temp = (_this = babelHelpers.possibleConstructorReturn(this, (_ref = Today.__proto__ || Object.getPrototypeOf(Today)).call.apply(_ref, [this].concat(args))), _this), _this.scrollToToday = function () {
